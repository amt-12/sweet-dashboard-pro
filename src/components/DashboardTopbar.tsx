...
const DashboardTopbar = () => {
  return (
    <header className="h-16 border-b border-border bg-card/80 backdrop-blur-sm flex items-center justify-between px-6 sticky top-0 z-10">
      <div>
        <h2 className="font-dancing text-xl font-bold text-foreground">
          Good Morning! ☀️
        </h2>
      ...
      <div className="flex items-center gap-3">
        ...
        {/* Add Product */}
        <button className="bakery-btn bg-chocolate text-cream flex items-center gap-2 text-sm">
          <Plus size={16} />
        ...
        {/* Avatar */}
        <div className="w-10 h-10 rounded-full bg-strawberry-light flex items-center justify-center text-lg font-bold font-dancing text-strawberry">
          B
        </div>
      </div>
    </header>
