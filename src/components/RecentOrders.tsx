const orders = [
  { id: "#1024", customer: "Sarah Johnson", items: "2x Croissant, 1x Latte", total: "$18.50", status: "Completed", emoji: "✅" },
  { id: "#1023", customer: "Mike Chen", items: "Custom Birthday Cake", total: "$85.00", status: "Preparing", emoji: "👨‍🍳" },
  { id: "#1022", customer: "Emma Wilson", items: "6x Macarons, 2x Eclair", total: "$32.00", status: "Ready", emoji: "📦" },
  { id: "#1021", customer: "James Brown", items: "1x Wedding Cake Tasting", total: "$45.00", status: "Pending", emoji: "⏳" },
  { id: "#1020", customer: "Lisa Park", items: "12x Cookie Box", total: "$28.00", status: "Completed", emoji: "✅" },
];
  ...
  return (
    <div className="bakery-card col-span-2 animate-fade-in" style={{ animationDelay: "500ms" }}>
      <div className="flex items-center justify-between mb-4">
        <div>
          <h3 className="font-fredoka text-lg font-bold text-foreground">Recent Orders 🛒</h3>
          <p className="text-sm text-muted-foreground">Latest bakery orders</p>
        </div>
